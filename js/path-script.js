...
var PathMenuObj = function(classname,options){
	...
	//Positon And Size
		var PathPosition = {position:'fixed',right:100,top:100,width:150,height:150};
	...
	//Default Button, Format：{'bg':'(option)','css':'(option)','cover':'(option)'};
		var Button = {'bg':'./Path/bg-item-2x.png','css':{width:150,height:150},'cover':'./Path/star-2x.png'};	
	...
	//Main Button
		var mainButton = [
			//Normal
			{'bg':'./img/earth.png','css':'','cover':'./img/cover.png','html':'<span class="cover"></span>'},
			//After Pop-up
	...
	//Item Button
		var itemButtons = [
			{'bg':'./img/icon/help.png','css':'','cover':'./img/icon/help_s.png','href':'help.html','target':'_parent'},
			{'bg':'./img/icon/chat.png','css':'','cover':'./img/icon/chat_s.png','href':'chat.html','target':'_parent'},
			{'bg':'./img/icon/picture.png','css':'','cover':'./img/icon/picture_s.png','href':'album.html','target':'_parent'},
			{'bg':'./img/icon/video.png','css':'','cover':'./img/icon/video_s.png','href':'video.html','target':'_parent'}
		];	
